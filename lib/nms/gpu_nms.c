 ...
 */
  ...
  __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_3nms_7gpu_nms_1gpu_nms, 0, __pyx_n_s_gpu_nms, NULL, __pyx_n_s_nms_gpu_nms, __pyx_d, ((PyObject *)__pyx_codeobj__8)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
